import { PUT_SUCCESS, DELETE_SUCCESS } from '@stoxy/core';

export default class StoxyElement extends HTMLElement {
    constructor() {
        super();
    }
    ...
    _dispatchUpdatedEvent(updateData) {
        const event = new CustomEvent('updated', { detail: updateData });
